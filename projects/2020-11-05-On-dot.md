...
<!-- First Grid -->
<div class="w3-row-padding w3-text-white w3-padding-64 w3-container">
...
<div class="w3-row-padding w3-white w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-third w3-center">
      <img src="/assets/repo/ondot/loop.png"  class="center w3-round-xlarge" >
    </div>
  </div>
</div>

<!-- Features Section -->
<div class="w3-container w3-text-white w3-padding-64 w3-center">
  ...
  <div class="w3-content w3-center">
    ...
    <div class="w3-row w3-white w3-padding-32 w3-margin">
      ...
      <div class="" style="margin:20px;">
        ...
        <h3 class="w3-twothird btn btn--warning" onclick="go_donate(20)" id="donate_but">Support <span class="w3-small w3-text-blue">with PayPal</span> & Download</h3>
      </div>
    </div>
  </div>
</div>
